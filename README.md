...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/curly-paper-ca94)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/curly-paper-ca94
```

A live public deployment of this template is available at [https://curly-paper-ca94.templates.workers.dev](https://curly-paper-ca94.templates.workers.dev)
